	...
	for f2 in files2:
		...
		for i in range(len(contours2)):
			...
			if w+h > 20 and w+h <= 25:
				cmax = []
				cmax.append(contours2[i])
				cv2.rectangle(outputImg,(x,y),(x+w,y+h),(0,215,255),2)
				

			if w+h > 25 and w+h <= 30:
				cmax = []
				cmax.append(contours2[i])
				cv2.rectangle(outputImg,(x,y),(x+w,y+h),(0,117,239),2)


			if w+h > 30 and w+h <= 500:
				cmax = []
				cmax.append(contours2[i])
